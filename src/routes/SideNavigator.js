...
import { CustomSidebarMenu, AppHeader, VectorIcon, ColorPicker } from '../components';
...
import {
  SettingsScreen, HelpScreen, FAQScreen, ReviewsScreen, NotificationScreen, PaymentScreen,
  CreditCardScreen, YourFriend, Chatscreen
} from '../screens';
...
const SideNavigator = (props) => {
  ...
  return (
    <Drawer.Navigator theme={colorValue} drawerContent={(props) => <CustomSidebarMenu {...props} />} screenOptions={{
      ...
      />
      <Drawer.Screen
        name={RouteName.CREDIT_CARD_SCREEN} component={CreditCardScreen}
        options={{
          headerTitle: (props) => <AppHeader  {...props} headerTitle={t("Card_Label")} />,
          ...HeaderArray,
          headerStyle: {
            backgroundColor: Colors.theme_background,
          },
      ...
      />
      <Drawer.Screen
        name={RouteName.YOUR_FRIEND} component={YourFriend}
        options={{
          headerTitle: (props) => <AppHeader  {...props} headerTitle={t("Your_Friend_Label")} />,
          ...HeaderArray,
          headerStyle: {
            backgroundColor: Colors.theme_background,
          },
